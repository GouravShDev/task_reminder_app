...
class MockAddTodoToDb extends _i1.Mock implements _i10.AddTodoToDb {
  ...
  @override
  _i6.Future<_i3.Either<_i7.Failure, int>> call(_i10.TodoParams? params) =>
...
/// A class which mocks [WatchIncompTodoList].
///
/// See the documentation for Mockito's code generation for more information.
class MockWatchIncompTodoList extends _i1.Mock
    implements _i12.WatchIncompTodoList {
  MockWatchIncompTodoList() {
    _i1.throwOnMissingStub(this);
  }
  ...
  _i2.TodosRepository get repository =>
      (super.noSuchMethod(Invocation.getter(#repository),
          returnValue: _FakeTodosRepository_0()) as _i2.TodosRepository);
  @override
  _i6.Future<_i3.Either<_i7.Failure, _i6.Stream<List<_i8.TodoWithTasksList>>>> call(
          _i9.NoParams? noParams) =>
      (super.noSuchMethod(Invocation.method(#call, [noParams]),
          returnValue:
              Future<_i3.Either<_i7.Failure, _i6.Stream<List<_i8.TodoWithTasksList>>>>.value(
                  _FakeEither_1<_i7.Failure,
                      _i6.Stream<List<_i8.TodoWithTasksList>>>())) as _i6
          .Future<_i3.Either<_i7.Failure, _i6.Stream<List<_i8.TodoWithTasksList>>>>);
  @override
  String toString() => super.toString();
}
